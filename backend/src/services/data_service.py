...
class DataService:
    ...
    def get_demand_history(self, sku: str) -> pd.Series:
        ...
        # Reindex the demand column only — dragging the string-typed StockCode
        # column through reindex(fill_value=0) breaks under pandas 2.x with
        # pyarrow-backed strings (TypeError: Invalid value '0' for dtype 'str').
        return (
